<div class="h-full min-h-0 flex flex-col">
        ...
        <div class="flex items-center gap-2">
            ...
            <div x-data="{ openExport: false }" class="relative">
                ...
                <div x-show="openExport" @click.outside="openExport = false" x-transition x-cloak
                     class="absolute right-0 mt-2 w-60 bg-white border border-slate-200 rounded-xl shadow-xl z-[70] p-3">
                    <div class="text-[11px] font-bold text-slate-500 uppercase tracking-wider mb-2">Chọn cột để xuất</div>
                    <div class="space-y-1.5 max-h-64 overflow-y-auto custom-scrollbar pr-1">
                        @foreach(\App\Exports\CommissionExport::COLUMNS as $colKey => $colLabel)
    ...
    <x-import-modal id="commissions" title="Import Bảng Hoa Hồng" model="importFile" :chunked="true" :template="true" />
