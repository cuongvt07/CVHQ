    ...
    <div x-data="{ mobileFilterOpen: false, catSearch: '' }" @keydown.escape.window="mobileFilterOpen = false" class="px-4 md:px-6 py-2 md:py-4 bg-white border-b border-slate-100 flex flex-col gap-2">
        <div class="flex items-center gap-2">
            ...
            <div class="relative flex-1 group">
                ...
                <input type="text" wire:model.live.debounce.500ms="search" placeholder="Tìm tên, mã SKU..." class="w-full bg-slate-50 border border-slate-200 rounded-xl py-2 pl-12 pr-6 text-[11px] focus:outline-none focus:border-electric-blue transition-all text-slate-900 shadow-sm">
            </div>
        ...
        {{-- Filter panel (slide-down) - mobile only --}}
