            ...
            <div class="flex flex-col gap-1">
                ...
                <div class="relative group/nav">
                    <a href="{{ route('products.restock') }}" class="flex items-center gap-3 px-4 py-2.5 rounded-xl transition-all {{ request()->routeIs('products.restock') ? 'bg-electric-blue/10 text-electric-blue border border-electric-blue/20' : 'text-slate-500 hover:text-slate-900 hover:bg-slate-200/50 border border-transparent' }}">
                        ...
                        <span x-show="!sidebarCollapsed || sidebarOpen" class="text-sm font-medium whitespace-nowrap">Dự toán nhập hàng</span>
                    </a>
                    <div x-show="sidebarCollapsed && !sidebarOpen" class="fixed left-20 px-3 py-1.5 bg-slate-900 text-white text-[10px] rounded-lg opacity-0 group-hover/nav:opacity-100 translate-x-2 group-hover/nav:translate-x-4 transition-all pointer-events-none z-[100] whitespace-nowrap shadow-xl">Dự toán nhập hàng</div>
                </div>
                @endif
            ...
            <div class="flex flex-col gap-1">
                ...
                <div class="relative group/nav">
                    <a href="{{ route('invoices.returns') }}" class="flex items-center gap-3 px-4 py-2.5 rounded-xl transition-all {{ request()->routeIs('invoices.returns') ? 'bg-electric-blue/10 text-electric-blue border border-electric-blue/20' : 'text-slate-500 hover:text-slate-900 hover:bg-slate-200/50 border border-transparent' }}">
                        ...
                        <span x-show="!sidebarCollapsed || sidebarOpen" class="text-sm font-medium whitespace-nowrap">Danh sách trả hàng</span>
                    </a>
                    <div x-show="sidebarCollapsed && !sidebarOpen" class="fixed left-20 px-3 py-1.5 bg-slate-900 text-white text-[10px] rounded-lg opacity-0 group-hover/nav:opacity-100 translate-x-2 group-hover/nav:translate-x-4 transition-all pointer-events-none z-[100] whitespace-nowrap shadow-xl">Danh sách trả hàng</div>
                </div>
                @endif
            </div>
        </div>
            ...
            <div class="flex flex-col gap-1">
                ...
                <div class="relative group/nav">
                    <a href="{{ route('system.logs') }}" class="flex items-center gap-3 px-4 py-2.5 rounded-xl transition-all {{ request()->routeIs('system.logs') ? 'bg-electric-blue/10 text-electric-blue border border-electric-blue/20' : 'text-slate-500 hover:text-slate-900 hover:bg-slate-200/50 border border-transparent' }}">
                        ...
                        <span x-show="!sidebarCollapsed || sidebarOpen" class="text-sm font-medium whitespace-nowrap">Lịch sử hệ thống</span>
                    </a>
                    <div x-show="sidebarCollapsed && !sidebarOpen" class="fixed left-20 px-3 py-1.5 bg-slate-900 text-white text-[10px] rounded-lg opacity-0 group-hover/nav:opacity-100 translate-x-2 group-hover/nav:translate-x-4 transition-all pointer-events-none z-[100] whitespace-nowrap shadow-xl">Lịch sử hệ thống</div>
                </div>
                @endif
            </div>
        </div>
