            ...
            <div x-show="open"
                ...
                <div class="px-4 sm:px-8 pt-4 sm:pt-8 pb-4 sm:pb-6 overflow-y-auto">
                    ...
                    <form wire:submit.prevent="save" class="space-y-3 sm:space-y-4">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative">
                                    <input type="text"
                                           ...
                                           placeholder="Nhập tiền tố, hệ thống tự gợi ý mã tiếp theo">
                                    <button type="button"
                                ...
                                @if($this->isAutoGenerated && $this->sku)
                                    <div class="mt-2 inline-flex max-w-full items-center gap-1.5 rounded-xl border border-electric-blue/25 bg-electric-blue/10 px-3 py-1.5 text-[10px] font-bold text-electric-blue shadow-[0_8px_24px_rgba(0,209,255,0.16)] backdrop-blur-md animate-in fade-in slide-in-from-top-1 duration-200">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" class="shrink-0 text-electric-blue"><polyline points="20 6 9 17 4 12"/></svg>
                                        <span class="min-w-0 truncate">Đã tự động gợi ý mã tiếp theo: {{ $this->sku }}</span>
                                    </div>
                                @endif
                            </div>
                        ...
                        <!-- Vị trí hàng hóa: nhiều ô; bấm "Thêm vị trí" để thêm khối input, lưu gộp lại -->
                        <div class="space-y-2">
                            <div class="flex items-center justify-between">
                                <label class="text-[10px] font-bold text-slate-400 uppercase tracking-widest ml-1">
                                    Vị trí hàng hóa<span class="text-rose-500 ml-0.5">*</span>
                                </label>
                                <button type="button" wire:click="addLocation" class="text-[10px] font-bold text-electric-blue uppercase tracking-widest hover:underline flex items-center gap-1 transition-all">
                            ...
                            <p class="text-[10px] text-slate-400 ml-1">Mỗi ô là một vị trí cất. Gõ để chọn vị trí có sẵn hoặc nhập vị trí mới; bấm “Thêm vị trí” để thêm ô.</p>
