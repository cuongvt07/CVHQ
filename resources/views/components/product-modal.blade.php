                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-6">
                            ...
                            <div class="space-y-2">
                                ...
                                @if($this->isAutoGenerated && $this->sku)
                                    <div class="mt-2 inline-flex max-w-full items-center gap-1.5 rounded-xl border border-electric-blue/25 bg-electric-blue/10 px-3 py-1.5 text-[10px] font-bold text-electric-blue shadow-[0_8px_24px_rgba(0,209,255,0.16)] animate-in fade-in slide-in-from-top-1 duration-200">
